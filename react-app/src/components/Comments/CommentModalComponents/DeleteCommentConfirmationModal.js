...
function DeleteCommentConfirmationModal({ comment }) {
    ...
    const confirmDelete = async () => {
        ...
        const data = await dispatch(deleteCommentThunk(comment))
        if (data) {
    ...
    return (
        <div className="delete_confirmation_modal_div">
            <h2 className="delete_confirmation_modal_title">Delete Comment</h2>
            <p className="delete_confirmation_modal_info">Are you sure you want to delete this comment?</p>
